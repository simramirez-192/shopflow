package com.shopflow.inventoryservice.exception;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Map<String, Object>> handle(InventoryException ex) {
        log.error("InventoryException: {}", ex.getMessage());
